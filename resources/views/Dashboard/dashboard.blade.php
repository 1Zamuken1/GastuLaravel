...
<div class="Principal">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-card-header">
                <div>
                    <div class="stat-number" id="ingresos-stat">
                        ${{ number_format($totalIngresos) }}
                        <span class="stat-detail">
                            (Ingresos: ${{ number_format($ingresosMesActual) }} + Proyecciones: ${{ number_format($proyeccionesMesActual) }})
                        </span>
                    </div>
                    <div class="stat-label">Total Ingresos (Mes actual)</div>
                </div>
        ...
        <div class="stat-card">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-label">Total Egresos (Mes actual)</div>
                </div>
        ...
        <div class="stat-card">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-label">Saldo Neto (Mes actual)</div>
                </div>
        ...
        <div class="stat-card">
            <div class="stat-card-header">
                <div>
                    ...
                    <div class="stat-label">Total Ahorros (Acumulado)</div>
                </div>
    ...
    <div class="controls-section">
        <button type="button" class="control-btn" onclick="window.location.href='{{ route('ahorros.index') }}'">
            <i class="bi bi-piggy-bank"></i> Gestionar Ahorros
        </button>
        <button type="button" class="control-btn" onclick="window.location.href='{{ route('ingresos.index') }}'">
            <i class="bi bi-arrow-up-circle"></i> Agregar Ingresos
        </button>
        <button type="button" class="control-btn" onclick="window.location.href='{{ route('egresos.index') }}'">
...
<script>
    window.dashboardData = {
        ingresosMes: @json($ingresosMes)
        , egresosMes: @json($egresosMes)
        , totalIngresos: @json($totalIngresos)
        , totalEgresos: @json($totalEgresos)
        , saldoNeto: @json($saldoNeto)
        , totalAhorros: @json($totalAhorros)
        , ahorroLabels: @json($ahorroLabels)
        , ahorroData: @json($ahorroData)
