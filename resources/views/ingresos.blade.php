...
<!-- Fin pruebas -->
   ...
   @vite([
    ...
    'resources/js/ingresos.js',
    'resources/js/ingresos-animaciones.js',
   ])
  </head>
  <body>
    <div class="layout">
      ...
      <main class="page-content">
        <div class="card">
          ...
          <table id="tablaIngresos" class="display full-width-table">
  <thead>
    <tr>
      <th>ID</th>
      <th>Concepto</th>
  ...
  <tbody>
    <!-- DataTable llenará esto por AJAX -->
  </tbody>
</table>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="formIngreso">
            ...
            <div class="form-group" id="recurrenciaContainer">
...
<span id="conceptoDescripcion" class="concepto-descripcion"></span>
          </form>
        </div>
    ...
    <!-- Scripts necesarios para DataTables y Vite -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<link rel="stylesheet" href="https://cdn.datatables.net/1.13.4/css/jquery.dataTables.min.css">
<script src="https://cdn.datatables.net/1.13.4/js/jquery.dataTables.min.js"></script>
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.4.1/css/buttons.dataTables.min.css">
